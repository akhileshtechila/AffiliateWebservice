 ...
 */
class Affiliateinfo extends \Affiliate\AffiliateManagementBundle\Entity\Affiliateinfo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Affiliate\\AffiliateManagementBundle\\Entity\\Affiliateinfo' . "\0" . 'id', '' . "\0" . 'Affiliate\\AffiliateManagementBundle\\Entity\\Affiliateinfo' . "\0" . 'fname', '' . "\0" . 'Affiliate\\AffiliateManagementBundle\\Entity\\Affiliateinfo' . "\0" . 'lname', '' . "\0" . 'Affiliate\\AffiliateManagementBundle\\Entity\\Affiliateinfo' . "\0" . 'username', '' . "\0" . 'Affiliate\\AffiliateManagementBundle\\Entity\\Affiliateinfo' . "\0" . 'password', '' . "\0" . 'Affiliate\\AffiliateManagementBundle\\Entity\\Affiliateinfo' . "\0" . 'email', '' . "\0" . 'Affiliate\\AffiliateManagementBundle\\Entity\\Affiliateinfo' . "\0" . 'state', '' . "\0" . 'Affiliate\\AffiliateManagementBundle\\Entity\\Affiliateinfo' . "\0" . 'country', '' . "\0" . 'Affiliate\\AffiliateManagementBundle\\Entity\\Affiliateinfo' . "\0" . 'zipcode', '' . "\0" . 'Affiliate\\AffiliateManagementBundle\\Entity\\Affiliateinfo' . "\0" . 'mobile', '' . "\0" . 'Affiliate\\AffiliateManagementBundle\\Entity\\Affiliateinfo' . "\0" . 'addedBy', '' . "\0" . 'Affiliate\\AffiliateManagementBundle\\Entity\\Affiliateinfo' . "\0" . 'createdat', '' . "\0" . 'Affiliate\\AffiliateManagementBundle\\Entity\\Affiliateinfo' . "\0" . 'updatedat', '' . "\0" . 'Affiliate\\AffiliateManagementBundle\\Entity\\Affiliateinfo' . "\0" . 'AffiliateDeal', '' . "\0" . 'Affiliate\\AffiliateManagementBundle\\Entity\\Affiliateinfo' . "\0" . 'AffiliatePayReq', '' . "\0" . 'Affiliate\\AffiliateManagementBundle\\Entity\\Affiliateinfo' . "\0" . 'AffiliatePayRel');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Affiliateinfo $proxy) {
