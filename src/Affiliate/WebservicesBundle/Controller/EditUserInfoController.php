...
class EditUserInfoController extends Controller {
    ...
    public function EditUserInfoAction(Request $request) {
        ...
        if($userId ==""){
            ...
            $userInfo = $em->getRepository("AffiliateAffiliateManagementBundle:Userinfo")->findBy(array('id' => $userId , 'userType' => 'Admin' ) );
            if(!$userInfo){
        ...
        return $this->render('AffiliateWebservicesBundle:EditUserInfo:EditUserInfo.html.twig');
    }
